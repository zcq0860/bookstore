...
import cn.bdu.dao.UserDao;
import cn.bdu.domain.User;
import cn.bdu.exception.ActiveUserException;
import cn.bdu.exception.RegisterException;
...
public class UserService {
	...
	public void register(User user) throws RegisterException {
		...
		try {
			...
			// 发送激活邮件
			String emailMsg = "感谢您注册网上书城，请点击<a href='http://localhost:8080/bookstore/activeUser?activeCode="
					+ user.getActiveCode() + "'>&nbsp;激活&nbsp;</a>，您便可以享受该书城的各项服务。<br>为保障您的账户安全，请在24小时内完成激活操作";
